...
typedef struct
{
  tContacto  contacto;  // Estructura con direcci�n, tel�fono y correo-e de la oficina donde se gestionan las tiendas
  int        n_tiendas; // N�mero total de tiendas
  tTienda    *p_tiendas;   // Puntero al inicio del array din�mico de las tiendas de la cadena
}tCadena;
